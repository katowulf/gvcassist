...
interface ChipProps {color: string, altColor: string, textColor: string, icon: string|null, altIcon: string}
...
export class Chip {
  ...
  constructor(public readonly label: string, props = {}) {
    this.props = Object.assign({
      color: "indigo", altColor: "error", textColor: "white",
      icon: null, altIcon: "mdi-undo-variant"
    }, props);
