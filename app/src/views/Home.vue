    ...
    <v-container class="fill-height" fluid>
      <v-row justify="center">
        <v-col md="4" offset-md="1">
          ...
          <p align="center">
            GVC Assistant is a simple companion tool for large distributed teams
            designed to encourage interaction and simplify participation during
            meetings.
          </p>
        </v-col>
      </v-row>
          ...
          <v-card outlined>
            ...
            <v-card-text>
              ...
              <p>
                ...
                automatically collected and emailed to task owners and
                moderators.
              </p>
              <p>
                <strong
                ...
                >
                Continue when everyone marks themselves ready or the time limit
                is reached.
              </p>
            </v-card-text>
          </v-card>
