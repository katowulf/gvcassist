    ...
    <v-row>
      <v-col md="6" offset-md="3">
        ...
        <p>
          ...
          <a href="https://vuetifyjs.com/">Vuetify</a>, Google Material
          <a href="https://material.io/">design</a> and
          <a href="https://materialdesignicons.com/">icons</a>, and
        ...
        <p>
          ...
          <code>--fix</code> when Vue spits out dozens of liter errors (mostly
          created by the CLI it's linting)
        ...
        <p>
          To Rie, Oskar, Nicolas, and many others behind the scenes, thanks for
